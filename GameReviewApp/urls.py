...
urlpatterns = [
    ...
    url(r'^game/recommend/(?P<game_id>\d+)/$', 'reviews.views.recommendation', name='recommend'),
    url(r'^game/opendiscussion/(?P<game_id>\d+)/$', 'reviews.views.open_discussion', name='opendiscussion'),
